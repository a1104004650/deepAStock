        ...
        <div class="split-grid mt8">
          ...
          <div class="card">
            <div class="flex between" style="align-items:center">
              <span class="fs14 bold">上证指数K线</span>
              <span class="fs12" style="color:#7d8390">日线 · 近半年</span>
            </div>
            <div class="mt8" style="position:relative">
              <HQChartKline :data="kline" height="300px" />
              <el-empty v-if="!kline.length" description="暂无上证指数K线数据" :image-size="40" />
            </div>
          </div>
        </div>
