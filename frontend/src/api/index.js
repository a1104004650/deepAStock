...
export const labApi = {
  ...
  resetCompetition: (id) => http.put(`/lab/competitions/${id}/reset`),
  competitionStats: (id) => http.get(`/lab/competitions/${id}/stats`),
  tradeAll: (compId, force = false) => http.post(`/lab/competitions/${compId}/trade-all`, null, { params: { force } }),
  ...
  checkParticipantHealth: (id) => http.post(`/lab/participants/${id}/check-health`),
  ...
  competitionTrades: (id, limit = 500) => http.get(`/lab/competitions/${id}/trades`, { params: { limit } }),
  participantPositions: (id) => http.get(`/lab/participants/${id}/positions`),
  chat: (compId) => http.get(`/lab/competitions/${compId}/chat`),
  chatAll: (compId) => http.post(`/lab/competitions/${compId}/chat-all`),
  sendChat: (compId, content) => http.post(`/lab/competitions/${compId}/chat`, { content }),
  // AI自主运行
  aiStart: (compId) => http.post(`/lab/competitions/${compId}/ai-start`),
  aiStop: (compId) => http.post(`/lab/competitions/${compId}/ai-stop`),
  aiStatus: (compId) => http.get(`/lab/competitions/${compId}/ai-status`),
  ...
  events: (compId, limit = 50) => http.get(`/lab/competitions/${compId}/events`, { params: { limit } }),
